package mediathek.werkzeuge.kundenauflister;
...
public class KundenTableModelTest
{
    ...
    public KundenTableModelTest()
    {
        ...
        _kundeSchmitz = new Kunde(Kundennummer.get(123456), "Susi", "Schmitz");
        _kundeSchmidt = new Kunde(Kundennummer.get(456789), "Klaus", "Schmidt");
